				...
				<AccordionItem value={tracker} class="last:border-0">
					{#if isWorking(tracker)}
						<div class="flex items-center gap-3 py-5">
							...
							<span class="min-w-0 flex-1">
								...
								<span class="block text-xs text-(--text-muted)">{provider(tracker)}</span>
							</span>
					...
					{:else}
						<AccordionTrigger class="py-5">
							<span class="flex min-w-0 flex-1 items-center gap-3">
								...
								<span class="min-w-0 flex-1">
									...
									<span class="block text-xs font-normal text-(--text-muted)">{provider(tracker)}</span>
								</span>
						...
						<AccordionContent class="space-y-5 sm:pl-13">
							...
							<p class="text-xs text-(--text-muted)">{lastSync(tracker)}</p>
